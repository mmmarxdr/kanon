...
3. kanon_transition_issue: backlog → todo → in_progress → review → done
4. kanon_update_issue: enrich description as work evolves
5. Deferred/later work → kanon_create_roadmap_item, NOT backlog
6. kanon_stop_work when done
