...
# Only copies the PRODUCT skills (kanon-mcp, kanon-init, kanon-onboard, kanon-create-issue, kanon-roadmap, kanon-cycle, kanon-orchestrator-hooks).
...
for skill in kanon-mcp kanon-init kanon-onboard kanon-create-issue kanon-roadmap kanon-cycle kanon-orchestrator-hooks; do
