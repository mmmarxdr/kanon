...
-- Backfill existing workspaces with a default policy
INSERT INTO "triage_policies" ("id", "workspace_id", "version", "retention_days", "disposition_list_visibility", "created_at")
SELECT gen_random_uuid(), "id", '1', 365, 'hidden', NOW() FROM "workspaces";
