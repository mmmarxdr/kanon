...
export const workCaptureOwnerKindSchema = z.enum(["web", "mcp", "implicit"]);
...
export const workCaptureOwnerCommandSchema = z
  .object({
    commandId: z.string().uuid(),
    ...workCaptureFenceFields,
...
export type WorkCaptureOwnerCommand = z.infer<typeof workCaptureOwnerCommandSchema>;
export type WorkCaptureOwnerKind = z.infer<typeof workCaptureOwnerKindSchema>;
